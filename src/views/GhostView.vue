...
import GhostCardButtons from '@/components/flash/GhostCardButtons.vue'
...
<template>
  <div id="flash-cards-wrapper">
    ...
    <div id="data-entry-wrapper">
      <div class="top-bar">
        <h1>{{ isDimsumView ? 'Ghost cards' : 'Basic flash cards' }}</h1>
        <div>
          <button class="black" @click="isDimsumView = !isDimsumView">
            Switch to {{ isDimsumView ? 'basic flash' : 'ghost' }} cards
          </button>
      ...
      <div class="explanation" v-if="cards === null">
        ...
        <GhostCardButtons @setCards="setCards" />
      </div>
